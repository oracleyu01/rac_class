...
- **29. RAC 환경에서 inactive 상태의 redo log file 이 손상되었을 복구 방법**: 📄[노트]()
- **30. RAC 환경에서  time base 불완전 복구하기**: 📄[노트]()
- **31. RAC 환경에서  cancel base 불완전 복구하기**: 📄[노트]()
- **32. RAC 환경에서 백업본이 없는 data file 이 깨졌을때 복구 방법**: 📄[노트]()
- **33. RAC 환경에서 flashback  database 로 불완전 복구하기**: 📄[노트]()
- **34. RAC 환경에서 실수로 테이블 스페이스를 drop 했을 때 복구 방법.**: 📄[노트]()
- **35. RAC 환경에서의 튜닝 요소**: 📄[노트]()
- **36. RAC 환경에서 instance recovery 튜닝**: 📄[노트]()
- **37. RAC 환경에서 instance recovery 파라미터 튜닝하기**: 📄[노트]()
- **38. RAC 튜닝 중 interconnect  traffic 튜닝**: 📄[노트]()
- **39. global  동기화 작업에 대한 경합 튜닝의 큰 개요**: 📄[노트]()
- **40. RAC 의 핵심 원리인 cache fusion 에 대한 설명**: 📄[노트]()
   &nbsp;
